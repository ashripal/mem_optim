"""
Plotting utilities for LongBench baseline run JSONL files.

TRUE BASELINE:
- Stateless LLM execution
- NO cache / NO memory reuse
...
- Generates plots commonly used in the baseline:
    1) Latency vs input tokens
    2) Tokens/sec vs input tokens
    3) RSS delta vs input tokens
    4) Latency histogram
